...
function GaleriPage() {
  ...
  const search = useSearch({ from: "/galeri" });
  const scriptType = search.scriptType ?? "all";
        ...
        <div className="container mx-auto px-6 lg:px-8 pt-32 pb-20 relative z-10">
          <div className="text-center mb-16 max-w-3xl mx-auto">
            ...
            <p className="text-clay font-medium text-base md:text-lg leading-relaxed">
              Koleksi prasasti digital yang telah diabadikan pada blockchain Ethereum Sepolia
              testnet.
            </p>
          </div>
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[1, 2, 3, 4, 5, 6].map((_, index) => (
                <div
                  key={index}
                  className="group relative bg-white border border-gold/20 rounded-xl overflow-hidden"
                >
            ...
            {prasasti.map((item, index) => (
              ...
              >
                ...
                <div className="relative h-48 w-full bg-sand flex items-center justify-center">
                  <div className="text-2xl font-bold text-ink px-4">{item.message}</div>
                </div>
                ...
                <div className="p-6">
                  ...
                  <h3 className="font-serif text-xl font-bold text-ink mb-3">Original</h3>
                  <p className="text-lg text-clay mb-4 font-mono">{item.name}</p>
                  ...
                  <div className="flex items-center gap-3 mb-4 text-sm text-clay">
                    ...
                    <div className="flex items-center gap-1">{formatDate(item.timestamp)}</div>
                  </div>
